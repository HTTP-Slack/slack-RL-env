...
const Pass = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="w-full px-8 py-6 flex justify-center items-center">
      ...
      <main className="flex-1 flex items-center justify-center px-8 pt-12 pb-20">
        <div className="w-full max-w-xl">
          <h1 className="text-[2.75rem] leading-tight font-bold text-black text-center mb-3">
            ...
            <div className="flex gap-2">
              {[0, 1, 2].map((index) => (
                <input
                  ...
                  className="w-14 h-16 text-center text-2xl font-semibold border border-gray-300 rounded-md focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                />
              ))}
            </div>
